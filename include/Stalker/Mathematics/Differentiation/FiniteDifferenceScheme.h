...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Central, ErrorOrder::O_2> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Central, ErrorOrder::O_4> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Central, ErrorOrder::O_6> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Forward, ErrorOrder::O_1> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Forward, ErrorOrder::O_2> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Forward, ErrorOrder::O_3> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Forward, ErrorOrder::O_4> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Forward, ErrorOrder::O_5> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Backward, ErrorOrder::O_1> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Backward, ErrorOrder::O_2> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Backward, ErrorOrder::O_3> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Backward, ErrorOrder::O_4> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<1, T_Scheme::Backward, ErrorOrder::O_5> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<2, T_Scheme::Central, ErrorOrder::O_2> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<2, T_Scheme::Central, ErrorOrder::O_4> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<2, T_Scheme::Central, ErrorOrder::O_6> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<2, T_Scheme::Forward, ErrorOrder::O_2> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<2, T_Scheme::Forward, ErrorOrder::O_3> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<2, T_Scheme::Forward, ErrorOrder::O_4> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<2, T_Scheme::Forward, ErrorOrder::O_5> {
...
template <>
struct FiniteDifferenceScheme<2, T_Scheme::Backward, ErrorOrder::O_2> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<2, T_Scheme::Backward, ErrorOrder::O_3> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<2, T_Scheme::Backward, ErrorOrder::O_4> {
...
//=================================================================================================
template <>
struct FiniteDifferenceScheme<2, T_Scheme::Backward, ErrorOrder::O_5> {
