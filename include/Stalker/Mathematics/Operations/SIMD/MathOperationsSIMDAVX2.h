...
namespace Stalker::Mathematics::SIMD
{
    ...
    private:
        ...
        static inline void _add(const Base::T_data *a, const Base::T_data *b, Base::T_data *result, std::index_sequence<Is...>,
            ...
            if constexpr (IsScaled)
                (StoreFunction<Policy>::store(result + Is * Base::registerSize, _mm256_fmadd_pd(_mm256_load_pd(a + Is * Base::registerSize), *scalarA,
    ...
    private:
        ...
        {
            if constexpr (IsScaled)
                (StoreFunction<Policy>::store(result + Is * Base::registerSize, _mm256_fmadd_ps(_mm256_load_ps(a + Is * Base::registerSize), *scalarA,
        ...
        {
            if constexpr (IsScaled)
                (StoreFunction<Policy>::store(result + Is * Base::registerSize, _mm256_mul_ps(_mm256_mul_ps(_mm256_load_ps(a + Is * Base::registerSize), *scalarA),
                                                                                              _mm256_mul_ps(_mm256_load_ps(b + Is * Base::registerSize), *scalarB))),
                 ...);
            else
    ...
    private:
        ...
        {
            if constexpr (IsScaled)
                (StoreFunction<Policy>::store(result + Is * Base::registerSize, _mm256_add_epi32(
        ...
        {
            if constexpr (IsScaled)
                (StoreFunction<Policy>::store(result + Is * Base::registerSize, _mm256_sub_epi32(
                            _mm256_mullo_epi32(_mm256_load_si256(reinterpret_cast<const __m256i*>(a + Is * Base::registerSize)), *scalarA),
                            _mm256_mullo_epi32(_mm256_load_si256(reinterpret_cast<const __m256i*>(b + Is * Base::registerSize)), *scalarB))), ...);
            else
                (StoreFunction<Policy>::store(result + Is * Base::registerSize, _mm256_sub_epi32(
        ...
        {
            if constexpr (IsScaled)
                (StoreFunction<Policy>::store(result + Is * Base::registerSize, _mm256_mullo_epi32(
                                                  _mm256_mullo_epi32(_mm256_load_si256(reinterpret_cast<const __m256i *>(a + Is * Base::registerSize)), *scalarA),
                                                  _mm256_mullo_epi32(_mm256_load_si256(reinterpret_cast<const __m256i *>(b + Is * Base::registerSize)), *scalarB))), ...);
            else
                (StoreFunction<Policy>::store(result + Is * Base::registerSize, _mm256_mullo_epi32(
