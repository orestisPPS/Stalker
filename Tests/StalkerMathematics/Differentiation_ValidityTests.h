...
namespace STLKR_Tests {
    ...
    public:
        ...
        void runTest() override {
            //Central
            Printers::printTitle("1st Derivative", "-", ColourType::WHITE);

            Printers::printSubtitle("Central Finite Difference Scheme", ColourType::PATSIOURA_RED);
            ...
            //Forward-
            Printers::printSubtitle("Forward Finite Difference Scheme", ColourType::PATSIOURA_RED);
            ...
            //Backward
            Printers::printSubtitle("Backward Finite Difference Scheme", ColourType::PATSIOURA_RED);
            ...
            Printers::printTitle("2nd Derivative", "-", ColourType::WHITE);
