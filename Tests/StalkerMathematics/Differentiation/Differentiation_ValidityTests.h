...
#include "../StalkerMathematics/Differentiation/Derivative.h"
...
namespace STLKR_Tests {
    ...
    public:
        ...
        void runTest() override {
            //Central
            Printers::printTitle("1st Derivative", "*", ColourType::BUTIAS_ORANGE);

            Printers::printTitle("Central Finite Difference Scheme", "-", ColourType::PATSIOURA_RED);
            ...
            //Forward-
            Printers::printTitle("Forward Finite Difference Scheme", "-", ColourType::PATSIOURA_RED);
            ...
            //Backward
            Printers::printTitle("Backward Finite Difference Scheme", "-", ColourType::PATSIOURA_RED);
            ...
            Printers::printTitle("2nd Derivative", "*", ColourType::BUTIAS_ORANGE);
