...
public:
    ...
    constexpr inline static void add(T_data *data1, T_data  *data2, T_data *result, T_data scale1, T_data scale2, unsigned size, CPU_Manager &manager, bool temporalStore = false) {
